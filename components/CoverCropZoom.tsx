      ...
      <div className="flex gap-4 p-4 border-t border-paletteBorder">
        ...
        <div className="flex gap-2 ml-auto">
          ...
          <button
            ...
            className="font-mono text-sm uppercase tracking-wider px-4 py-2 bg-textPrimary text-white hover:opacity-90 disabled:opacity-50 transition-opacity duration-150 rounded-none"
          >
